...
namespace WebApplication1.Controllers
{
    ...
    public class ValuesController : RootController
    {
        ...
        public ValuesController(ILoggerFactory loggerProvider, IUserPrincipalBuilder userPrincipalBuilder)
        {
        ...
        {
            logger.LogInformation("id de entrada: " + id);
        ...
        {
            var tst = teste;
            return Ok(userPrincipalBuilder.UserPrincipal);
        }
